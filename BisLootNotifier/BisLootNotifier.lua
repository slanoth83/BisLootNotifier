...
local BisRollIcon, BisRollLinkText 
...
EventFrame:SetScript("OnEvent", function(self, event, arg1)
    if event == "ADDON_LOADED" and arg1 == AddonName then
        ...
        if RollFrame and BisLootSettings.rollFramePos then
        ...
        print("|cff00ff00BiS Manager Loaded.|r Type /bis to open.")
...
-- HELP FRAME (Translated to English)
...
RollLockBtn:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
    GameTooltip:SetText(BisLootSettings.rollFrameLocked and "Unlock Frame" or "Lock Frame")
    GameTooltip:Show()
end)
